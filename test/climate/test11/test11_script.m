...
%
%%
save(fullfile(main_folder,'test/climate/test11/opt_params_climate_menaka.mat'),'climate_params','windows_params')
%%
save(fullfile(main_folder,'test/climate/test11/test11_ws.mat'))
