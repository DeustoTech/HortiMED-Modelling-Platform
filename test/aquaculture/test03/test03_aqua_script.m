...
tp_tilapia.Twall = 273.15 + 20;
tp_tilapia.wall_gain = 20;

x0_tank_tilapia = tank_ic;
x0_tank_tilapia.T = 273.15 + 17;
x0_tank_tilapia.h = 0.75;
%%
%
x0_tank_mullet = tank_ic;
x0_tank_mullet.T = 273.15 + 17.5;
x0_tank_mullet.h = 0.75;

%
tp_mullet = tp_tilapia;
tp_mullet.Twall = 273.15 + 19.5;
tp_mullet.wall_gain = 20;
%%
%
x0_tank_clams = tank_ic;
x0_tank_clams.T = 273.15 + 16;
x0_tank_clams.h = 0.75;
%
tp_clams = tp_tilapia;
tp_clams.Twall = 273.15 + 17;
tp_clams.wall_gain = 20;

%%
x0_tank_sedim = tank_ic;
x0_tank_sedim.T = 273.15 + 16;
x0_tank_sedim.h = 0.75;

%
tp_sedim = tp_tilapia;
tp_sedim.Twall = 273.15 + 16;
tp_sedim.wall_gain = 10;

%%
hour0 = DateTime(1).Hour+DateTime(1).Minute/60;
%%
%x0_tank_clams.T = 273.15 + 16;
%x0_tank_clams.h = 0.8;
...
%%
set_param('test17','StopTime','tspan(end)')
r = sim('test17');
%%
rl = r.logsout;
%%
